...
public class Assignments {
     ...
     * 5. Else, if arr[start]<=arr[mid]i.e the element lies in left sorted array.
     * Then check if the key lies between arr[s] and arr[mid]. If so then do
     * end=mid-1; else do s=mid+1;
     * 6. Else the target lies in right sorted array. Check if the target value lies
     * between arr[mid] and arr[end].if so then do s=mid+1; Else do e=mid-1;
